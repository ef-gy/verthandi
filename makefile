...
PCLDFLAGS:=$(shell $(PKGCONFIG) --libs $(LIBRARIES) 2>/dev/null) -lboost_system -lboost_regex
...
IINCLUDES:=$(addprefix $(INCLUDEDIR)/verthandi/,$(notdir $(wildcard include/verthandi/*.h)))
